...
import com.qlshopquanaonhom6.shoponline.activity.ChitietsanphamActivity;
...
public class SanphamAdapter extends RecyclerView.Adapter<SanphamAdapter.ItemHolder> {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ItemHolder imItemHolder = new ItemHolder(v);
        ...
        public ItemHolder(@NonNull View itemView) {
           ...
           itemView.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   Intent quang = new Intent(context, ChitietsanphamActivity.class);
                   quang.putExtra("thongtinsanpham",arraysanpham.get(getPosition()));
                   quang.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                   CheckConnection.showToast_Short(context,arraysanpham.get(getPosition()).getTensanpham());
                   context.startActivity(quang);
               }
           });
